...
#python3 apps/calibration/detect_line.py  $(pwd)/data/extri --out $(pwd)/data/extri/output/calibration --pattern 5,2 --distance 1 --len 2.5

## 手动处理地面标记数据
#python3 apps/annotation/annot_calib.py $(pwd)/data/extri --mode chessboard --annot chessboard --pattern 5,2
